    ...
    <v-main class="login-background d-flex flex-column">
      <v-container fluid fill-height class="pa-0 flex-grow-1">
        <v-row no-gutters class="fill-height flex-column justify-center">
          <v-col class="d-flex flex-column align-center">
            ...
            <v-text-field v-model="email" label="Email or Phone" variant="outlined" color="white" bg-color="transparent"
              class="custom-text-field rounded-textfield" rounded="lg" width="100%" max-width="400">
              <template v-slot:prepend-inner>
                <v-icon icon="mdi-account" color="white"></v-icon>
              </template>
            </v-text-field>
            <v-text-field v-model="password" label="Password" variant="outlined" color="white" bg-color="transparent"
              type="password" class="custom-text-field rounded-textfield" rounded="lg" width="100%" max-width="400">
              <template v-slot:prepend-inner>
      ...
      <v-card class="white-card custom-rounded-top" elevation="0" width="100%">
        <v-card-text class="custom-padding">
          ...
          <v-btn color="#4c8479" @click="doLogin1" rounded="pill" class="login-btn mb-4" block size="x-large">
